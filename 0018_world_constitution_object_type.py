"""Allow world_constitution in objects.type check constraint.

Revision ID: 0018_world_constitution_type
Revises: 0017_db_integrity_hardening
...
revision: str = "0018_world_constitution_type"
down_revision: Union[str, None] = "0017_db_integrity_hardening"
branch_labels: Union[str, Sequence[str], None] = None
depends_on: Union[str, Sequence[str], None] = None

PREV_ALLOWED = (
    "player,npc,zone,item,faction,quest,claim,"
