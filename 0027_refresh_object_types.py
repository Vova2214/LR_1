"""Refresh objects type check for current internal memory object types.

Revision ID: 0027_refresh_object_types
Revises: 0026_continuity_memory_objects
Create Date: 2026-03-11 14:25:00.000000
...
revision: str = "0027_refresh_object_types"
down_revision: Union[str, None] = "0026_continuity_memory_objects"
branch_labels: Union[str, Sequence[str], None] = None
depends_on: Union[str, Sequence[str], None] = None

PREV_ALLOWED = (
    "player,npc,zone,item,faction,quest,claim,world_constitution,"
    "__world_prompt_chunk,__memory_seed,__session_summary,__narrative_spine,"
    "__memory_consolidated,__entity_memory,__callback_memory"
)
NEW_ALLOWED = (
    "player,npc,zone,item,faction,quest,claim,world_constitution,"
